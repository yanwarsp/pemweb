...
<head>
  ...
  <title>Projects - Yanwar Slamet</title>
</head>
...
<body>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav bordermenu">
          ...
          <li class="nav-item rounded-pill me-3 d-flex justify-content-center menucolor align-items-center">
            <a class="nav-link text-light active" aria-current="page" href="projects.php">&nbsp;&nbsp;Projects&nbsp;&nbsp;</a>
          </li>
          <li class="nav-item rounded-pill me-3 d-flex justify-content-center align-items-center">
  ...
  <div class="container text-center text-light font2">
    <div class="row my-5 pb-2">
      ...
      <div class="col-sm-5 my-2 mb-2 mx-auto">
        <div class="card fonttext roundedcard">
          <img src="<?= $data[0]['image']; ?>" class="card-img-top" alt="..." width="250px" height="250px">
          <div class="card-body">
